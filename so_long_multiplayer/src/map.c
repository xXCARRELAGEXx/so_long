...
/*   Updated: 2024/01/17 16:24:46 by rrault           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	store_image(t_data *data)
{
	...
	data->image.player2[0] = mlx_xpm_file_to_image
		(data->mlx, "image/joueur2_up.xpm", &s, &s);
	data->image.player2[1] = mlx_xpm_file_to_image
		(data->mlx, "image/joueur2_l.xpm", &s, &s);
	data->image.player2[2] = mlx_xpm_file_to_image
		(data->mlx, "image/joueur2_d.xpm", &s, &s);
	data->image.player2[3] = mlx_xpm_file_to_image
		(data->mlx, "image/joueur2_r.xpm", &s, &s);
	data->image.victory = mlx_xpm_file_to_image
		(data->mlx, "image/victory.xpm", &s, &s);
	data->image.defeat = mlx_xpm_file_to_image
		(data->mlx, "image/defeat.xpm", &s, &s);
}
	...
	while (data->level[y])
	{
		...
		while (data->level[y][x])
		{
			if (data->level[y][x] == '1')
				...
				print_image(data, data->image.player2[0], x, y);
			x++;
		}
		y++;
	}
